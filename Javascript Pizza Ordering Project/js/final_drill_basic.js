...
function getSauce(runningTotal, text1) {
	...
	text1 = text1+sauce+"<br>";
	console.log(sauce + " is the sauce");
...
function getCrust(runningTotal, text1) {
	...
	var stuffed = "Cheese Stuffed Crust + $3.00"
	var premium = 3;
	var crustTotal = runningTotal;
	if (crust == stuffed) {
		crustTotal = (runningTotal + premium);
	} 
	runningTotal = crustTotal;
	text1 = text1+crust+"<br>";
	console.log(crust + " is the crust");
...
function getCheese(runningTotal, text1) {
	...
	var extra = "Extra Cheese + $3.00"
	var premium = 3;
	var cheeseTotal = runningTotal;
	if (cheese == extra) {
		cheeseTotal = (runningTotal + premium);
	} 
	runningTotal = cheeseTotal;
	text1 = text1+cheese+"<br>";
	console.log(cheese + " is the cheese");
